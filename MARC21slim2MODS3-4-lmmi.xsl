...
-->
		...
		<xsl:for-each
			select="marc:datafield[@tag=501 or @tag=507 or @tag=513 or @tag=514 or @tag=516 or @tag=522 or @tag=525 or @tag=526
			or @tag=544 or @tag=547 or @tag=550 or @tag=552 or @tag=555 or @tag=556 or @tag=565 or @tag=567 or @tag=580 or
			@tag=584 or @tag=586]">
...
-->
	...
	<xsl:template name="createNoteFrom590">
		<note type="collection">
			<xsl:value-of select="marc:datafield[@tag=590]"/>
		</note>
	</xsl:template>
	<!-- for lindsey -->
